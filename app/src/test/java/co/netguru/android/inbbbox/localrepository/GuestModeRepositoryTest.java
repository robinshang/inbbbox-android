...
public class GuestModeRepositoryTest {
    ...
    @Before
    public void setUp() {
        guestModeRepository = new GuestModeRepository(sharedPreferencesMock, gson);
    ...
    public void whenAddLikeIsCalled_thenGetLikesFromPrefs() {
        ...
        guestModeRepository.addLikedShot(exampleShot).subscribe(subscriber);
    ...
    public void whenIsLikedCalled_thenGetLikesFromPrefs() {
        ...
        guestModeRepository.isShotLiked(exampleShot).subscribe(subscriber);
    ...
    public void whenRemoveCalled_thenGetLikesFromPrefs() {
        ...
        guestModeRepository.removeLikedShot(exampleShot).subscribe(subscriber);
